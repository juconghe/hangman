...
public class HangManGameArray {
	 ...
	 */
	public HangManGameArray(HangMan hangman, GameBoard board, String word) {
	...
	public void play() {
		...
		do {
			...
			if (!board.isPriorGuess(guess)) {
				...
				System.out.println("allready guessed this one, not executing doMove");
	...
	public static void main(String[] args) {
		...
		GameBoard   board   = new GameBoardArray(word);
		HangManGameArray game    = new HangManGameArray(hangman, board, word);
		game.play();
	}
